...
$("#submit").on("click", function (event) {
  ...
  formData.append("audio", recordedFile); // Append the audio blob with the filename to the form data

  // Send the form data with audio using AJAX
  ...
  xhr.send(formData);
  // const juz = document.getElementById("juzSelector").value;
